            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                        aria-controls="nav-profile" aria-selected="false">Daftar Organisasi</a>
                </div>
            </nav>
                                ...
                                <form action="{{ route('organisasi.store') }}" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="">Penyelenggara Organisasi</label><span class="text-danger">*</span>
                                        ...
                                        <div class="form-group">
                                            <label for="">Tingkat Organisasi</label><span class="text-danger">*</span>
                                        ...
                                        <div class="form-group">
                                            <label for="">Kategori Organisasi</label><span class="text-danger">*</span>
                                            <select class="form-control" name="kategori_organisasi" id="tingkat">
                                        ...
                                        <tbody>
                                            @forelse ($organisasi as $data)
                                                <tr>
                                                    ...
                                                    <td><a name="" id="" class="btn btn-primary btn-sm" href="{{route('organisasi.show',encrypt($data->id_organisasi))}}" role="button">Detail</a></td>
                                                </tr>
                                            @empty
...
@section('js')
    <script>
        $('#table').DataTable();
        $('#penyelenggara,#tingkat,#peran,#kategori').select2();
