                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="text-center card-footer">
                                <button type="button" onclick="confirmation('form-penghargaan')"  class="btn bg-blue-400 hover:bg-cyan-400 text-white btn-md"><i class="fas fa-save" aria-hidden="true"></i> Kirim Data</button>
                            </div>
                            </form>
                        </div>
                    </div>
