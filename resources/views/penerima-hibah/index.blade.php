...
@section('content_header')
    <div class="row">
        <div class="mb-3 col-12">
            <h1 class="m-0 font-bold text-dark uppercase"><i class="fa fa-bookmark" aria-hidden="true"></i> Penerima Hibah</h1>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="text-center card-footer">
                                <button type="button" onclick="confirmation('form-penerima-hibah')"  class="btn btn-md bg-blue-400 hover:bg-cyan-400 text-white shadow-md"><i class="fas fa-save" aria-hidden="true"></i> Kirim Data</button>
                            </div>
                            </form>
                        </div>
                    </div>
