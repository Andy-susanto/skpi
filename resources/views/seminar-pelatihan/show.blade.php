...
@section('content_header')
    <h1 class="m-0 text-dark"><span><a name="" id="" class="btn btn-default btn-sm" href="{{route('seminar-pelatihan.index')}}" role="button">Kembali</a></span> Seminar Pelatihan Detail</h1>
@stop
@section('content')
<div class="row">
    <div class="col-12">
