...
@section('content_header')
    <div class="row">
        <div class="mb-3 col-12">
            <h1 class="m-0 font-bold text-dark uppercase"><i class="fa fa-bookmark" aria-hidden="true"></i> Pengabdian Masyarakat</h1>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-body">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="font-bold nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                        aria-controls="nav-profile" aria-selected="false"><i class="fa fa-book" aria-hidden="true"></i> Daftar Pengabdian Masyarakat</a>
                </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <form action="{{ route('pengabdian-masyarakat.store') }}" method="post"
                                    enctype="multipart/form-data" id="form-pengabdian-masyarakat">
                            ...
                            <div class="text-center card-footer">
                                <button type="button" onclick="confirmation('form-pengabdian-masyarakat')"  class="btn bg-blue-400 hover:bg-cyan-400 text-white btn-md"><i class="fas fa-save" aria-hidden="true"></i> Kirim Data</button>
                            </div>
                            </form>
                        </div>
                    </div>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="triggerId">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('pengabdian-masyarakat.show', encrypt($data->id_pengabdian_masyarakat)) }}"><i
                                                                        class="fa fa-info" aria-hidden="true"></i>
                                                                    Detail</a>
                                                                <a class="dropdown-item" href="{{route('pengabdian-masyarakat.edit',encrypt($data->id_pengabdian_masyarakat))}}"><i class="fas fa-edit"
