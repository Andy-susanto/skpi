            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                        aria-controls="nav-profile" aria-selected="false">Daftar Pengabdian Masyarakat</a>
                </div>
            </nav>
                                        ...
                                        <tbody>
                                            @forelse ($pengabdian as $data)
                                                <tr>
                                                    ...
                                                    <td><a name="" id="" class="btn btn-primary btn-sm" href="{{route('penghargaan-kejuaraan.show',encrypt($data->id_pengabdian_masyarakat))}}" role="button">Detail</a></td>
                                                </tr>
                                            @empty
